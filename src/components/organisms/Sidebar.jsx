...
return (
    <div className={cn("w-64 bg-surface border-r border-primary-200 flex flex-col", className)}>
      {/* Logo */}
      <div className="p-6 border-b border-primary-200">
        <Link to="/" className="flex items-center space-x-3 group">
          ...
          <div>
            <h1 className="text-xl font-display font-bold text-primary-900">ScriptForge</h1>
